...
class Home {
    ...
    public function getBanerpost($cate,$start,$limit){
    	$sql = "SELECT * FROM vi_posts WHERE view = 1 AND status = 1 AND cate_id LIKE '%$cate%' ORDER BY order_by DESC LIMIT $start,$limit";
    	$result = $this->posts->rawQuery($sql);
		return $result;
    }
